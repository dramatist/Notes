...
* Converter仅能转换单一的SourceType和TargetType，使用GenericConverter替换
...
GenericTypeResolver工具类

* 处理类型相关方法
    * resolveReturnType
    * resolveType
* 处理泛型参数类型ParameterizedType
    * resolveReturnTypeArguments
    * resolveTypeArgument
    * resolveTypeArguments
* 处理泛型类型变量TypeVariable
    * getTypeVariableMap

GenericCollectionTypeResolver工具类，4.3后移除
...
ResolvableType，GenericTypeResolver和GenericCollectionTypeResolver的替代者
